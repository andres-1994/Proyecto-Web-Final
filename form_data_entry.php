			...
			<div class="card-body">
				<form action="controladores/eliminar_marcado.php" method="POST">
					<table id="mi-tabla" class="table table-striped table-bordered table-hover display nowrap" cellspacing="0" style="width:100%">
						...
						<tbody>
							<?php 
							$query = "SELECT CONCAT(codigo,id) codigo, id, ci, nombre, apellido, telefono, correo, direccion, fecha_nacimiento, TIMESTAMPDIFF(YEAR,fecha_nacimiento,CURDATE()) AS edad, fecha_ingreso, estado FROM datos_usuarios WHERE estado = 'activo' ORDER BY id DESC";
